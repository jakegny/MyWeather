...
import com.madmanwithagreenhat.myweather.MainActivity;
import com.madmanwithagreenhat.myweather.R;
import com.madmanwithagreenhat.myweather.Utility;
...
public class AppSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.COL_DATE, dateTime);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            locationValues.put(WeatherContract.LocationEntry.COL_LOCATION_SETTING, locationSetting);
            locationValues.put(WeatherContract.LocationEntry.COL_COORD_LAT, lat);
            locationValues.put(WeatherContract.LocationEntry.COL_COORD_LONG, lon);
